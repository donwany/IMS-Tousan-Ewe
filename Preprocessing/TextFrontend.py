...
class ArticulatoryCombinedTextFrontend:
    ...
    def get_example_sentence(lang):
        if lang == "eng":
            ...
            return "Nye Paulo, Yesu Kristo ƒe dɔla, ame si wotia be wòanye mawunyadɔgbedela, eye wodɔe be wòaɖe gbeƒã Mawu ƒe nyanyui la. Mawu do Nyanyui sia ŋugbe xoxoxo to eƒe nyagblɔɖilawo dzi le Ŋɔŋlɔ Kɔkɔeawo me, tso Via, Yesu Kristo, ame si va xexea me abe amegbetɔ ene, eye wodzii abe David ƒe tɔgbuiyɔvi ene la ŋu"
        elif lang == "ell":
...
if __name__ == "__main__":
    ...
    tf = ArticulatoryCombinedTextFrontend(language="ewe")
    tf.string_to_tensor(
        "Nye Paulo, Yesu Kristo ƒe dɔla, ame si wotia be wòanye mawunyadɔgbedela, eye wodɔe be wòaɖe gbeƒã Mawu ƒe nyanyui la. Mawu do Nyanyui sia ŋugbe xoxoxo to eƒe nyagblɔɖilawo dzi le Ŋɔŋlɔ Kɔkɔeawo me, tso Via, Yesu Kristo, ame si va xexea meabe amegbetɔ ene, eye wodzii abe David ƒe tɔgbuiyɔvi ene la ŋu.",
        view=True,
    )
