...
STAGE 4: Training only on high-quality data, to move the default of the model to produce cleaner speech
...
def run(
    ...
    base_dir = os.path.join(MODELS_DIR, "ToucanTTS_MassiveDataBigModel_stage3")
