...
def run(
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_nchlt_afr(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_nchlt_nso(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_nchlt_sot(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_nchlt_ssw(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_nchlt_tsn(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_nchlt_tso(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_nchlt_ven(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_nchlt_xho(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_nchlt_zul(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_bembaspeech(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_alffa_sw(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_alffa_am(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_alffa_wo(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_malayalam(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_msc(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_chuvash(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_iban(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_sundanese_speech(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_sinhala_speech(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_bengali_speech(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_nepali_speech(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_javanese_speech(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_african_voices_fon_alf(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_african_voices_hausa_cmv(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_african_voices_ibibio_lst(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_african_voices_kikuyu_opb(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_african_voices_lingala_opb(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_african_voices_ganda_cmv(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_african_voices_luo_afv(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_african_voices_luo_opb(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_african_voices_swahili_llsti(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_african_voices_suba_afv(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_african_voices_wolof_alf(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_african_voices_yoruba_opb(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_zambezi_voice_nyanja(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_zambezi_voice_lozi(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_zambezi_voice_tonga(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_afrikaans(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_amharic(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_arabic(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_assamese(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_asturian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_azerbaijani(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_belarusian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_bulgarian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_bengali(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_bosnian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_catalan(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_cebuano(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_sorani_kurdish(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_mandarin(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_czech(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_welsh(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_danish(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_german(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_greek(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_english(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_spanish(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_estonian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_persian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_finnish(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_filipino(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_french(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_irish(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_galician(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_gujarati(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_hausa(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_hebrew(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_hindi(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_croatian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_hungarian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_armenian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_indonesian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_igbo(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_icelandic(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_italian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_javanese(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_georgian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_kamba(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_kabuverdianu(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_kazakh(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_khmer(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_kannada(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_korean(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_luxembourgish(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_ganda(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_lingala(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_lao(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_lithuanian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_luo(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_latvian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_maori(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_macedonian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_malayalam(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_mongolian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_marathi(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_malay(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_maltese(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_dutch(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_northern_sotho(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_nyanja(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_occitan(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_oriya(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_punjabi(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_polish(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_pashto(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_portuguese(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_romanian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_russian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_sindhi(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_slovak(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_slovenian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_shona(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_somali(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_serbian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_swedish(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_swahili(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_tamil(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_telugu(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_tajik(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_turkish(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_ukrainian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_umbundu(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_urdu(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_uzbek(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_vietnamese(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_wolof(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_fleurs_yoruba(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_living_audio_dataset_irish(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_living_audio_dataset_dutch(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_living_audio_dataset_russian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_romanian_db(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_shemo(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_mslt_english(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_mslt_chinese(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_cmu_arctic(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_clartts(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_snow_mountain_bhadrawahi(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_snow_mountain_bilaspuri(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_snow_mountain_dogri(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_snow_mountain_gaddi(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_snow_mountain_haryanvi(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_snow_mountain_hindi(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_snow_mountain_kangri(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_snow_mountain_kannada(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_snow_mountain_kulvi(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_snow_mountain_kulvi_outer_seraji(),
            corpus_dir=os.path.join(
                PREPROCESSING_DIR, "snow_mountain_kulvi_outer_seraji"
            ),
            lang=lang_id,
            gpu_count=gpu_count,
            rank=rank,
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_snow_mountain_malayalam(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_snow_mountain_mandeali(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_snow_mountain_pahari_mahasui(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_snow_mountain_tamil(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_snow_mountain_telugu(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_ukrainian_lada(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_m_ailabs_german(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_m_ailabs_spanish(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_m_ailabs_french(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_m_ailabs_italian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_m_ailabs_polish(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_m_ailabs_russian(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_m_ailabs_ukrainian(),
    ...
    for lang in [
        ...
        datasets.append(
            [
                prepare_aligner_corpus(
                    transcript_dict=build_path_to_transcript_dict_mms_template(
                        lang=lang
                    ),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_vctk,
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_nvidia_hifitts,
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_CREMA_D,
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_EmoV_DB,
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_ESDS,
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_bernd,
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_friedrich,
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_thorsten_emotional(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_thorsten_neutral(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_thorsten_2022_10(),
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_css10fr,
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_synpaflex_norm_subset,
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_siwis_subset,
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_css10es,
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_css10cmn,
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_css10nl,
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_css10el,
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_css10fi,
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_css10ru,
    ...
    datasets.append(
        prepare_aligner_corpus(
            transcript_dict=build_path_to_transcript_dict_css10hu,
