...
def sound_of_silence_single_utt(
        version, model_id="Meta", exec_device="cpu", speaker_reference=None
):
    os.makedirs("audios", exist_ok=True)
...
def ewe_spoken(version, model_id="Meta", exec_device="cpu", speaker_reference=None):
    os.makedirs("audios", exist_ok=True)
    ...
    read_texts(
        ...
        filename=f"audios/{version}_ewe_spoken.wav",
        device=exec_device,
        language="ewe",
        speaker_reference=speaker_reference,
    )
...
if __name__ == "__main__":
    ...
    merged_speaker_references = [
        ...
        for ref in os.listdir("/home/ts75080/Documents/IMS-Toucan/audios/speaker_references/")
    ]

    sound_of_silence_single_utt(
        version="new_voc",
        model_id="Meta",
